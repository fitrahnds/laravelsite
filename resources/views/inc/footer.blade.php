                ...
                <div class="col-md-4">
                    ...
                    <div class="footer-widget about-widget">
                        <div class="footer-logo">
                            <a href="#" class="logo">
                                <img src="/storage/img/logo-alt.png" alt="">
                            </a>
                        ...
                        <article class="article widget-article">
                            ...
                            <div class="article-body">
                                ...
                                <ul class="article-meta">
                                    <li>
                                        <i class="fa fa-clock-o"></i> January 31, 2017</li>
                                    <li>
                                        <i class="fa fa-comments"></i> 33</li>
                                </ul>
                            </div>
                        </article>
                        <!-- /ARTICLE -->
                        ...
                        <ul>
                            <li class="tweet">
                                ...
                                <div class="tweet-body">
                                    <p>
                                        <a href="#">@magnews</a> Populo tritani laboramus ex mei, no eum iuvaret ceteros euripidis
                                        <a
                                            href="#">https://t.co/DwsTbsmxTP</a>
                                    </p>
                                </div>
                            </li>
                        </ul>
